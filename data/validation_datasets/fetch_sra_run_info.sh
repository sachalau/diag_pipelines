...
do
    ...
    snakemake --snakefile ${pipeline_folder}/workflows/typing.rules --config sra_samples=${bioproject}_${genus}-${species}.tsv species="${genus} ${species}" --configfile ${pipeline_folder}/data/validation_datasets/config.yml -n typing/freebayes_joint_genotyping/cgMLST/bwa/distances_in_snp_mst_no_st.svg typing/gatk_gvcfs/cgMLST/bwa/distances_in_snp_mst_no_st.svg phylogeny/freebayes_joint_genotyping/cgMLST/bwa/phylogeny_no_st.svg
